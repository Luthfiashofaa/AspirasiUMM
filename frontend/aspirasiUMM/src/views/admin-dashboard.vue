<template>
  <main class="main users chart-page" id="skip-target">
    <div class="container-dashboard" style="margin: 20pt">
              ...
              <tbody>
                ...
                >
                  ...
                  <td>
                    ...
                    >
                      <button class="btn btn-empty">Detail</button>
                    </router-link>
                  </td>
                </tr>
              </tbody>
...
export default {
  ...
  methods: {
    ...
    try {
        ...
        const response = await api.put(`/api/complaint/${complaintId}`, {
            status: newStatus
        });
        ...
        if (complaint) {
            complaint.status = complaint.status === 'answered' ? 'unanswered' : 'answered';
        }
